...
📌 Professional Background
    ...
    Proven experience working on production systems, scalability, and clean architecture
    Actively upskilling and transitioning into AI/ML, RAG systems, and LLM-based applications

📌 Current Focus Areas
    Retrieval-Augmented Generation (RAG)
    Large Language Models (LLMs)
    LangChain & LangGraph : AI Agents & Agentic AI
